package fr.emmanuelgautier.ci.repository;

import fr.emmanuelgautier.ci.JhipsterApp;
import fr.emmanuelgautier.ci.config.Constants;
import fr.emmanuelgautier.ci.config.audit.AuditEventConverter;
import fr.emmanuelgautier.ci.domain.PersistentAuditEvent;
...
import static fr.emmanuelgautier.ci.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
